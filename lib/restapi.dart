...
class DataService {
  Future insertAppFunctionality(String appid, String title, String description,
      String tanggal_mulai, String prioritas, String alarm) async {
    String uri = 'https://io.etter.cloud/v4/insert';

    try {
      final response = await http.post(Uri.parse(uri), body: {
        'token': '67072eb91be56c51cde09da5',
        'project': 'reminder_app',
        'collection': 'app_functionality',
        'appid': appid,
        'title': title,
  ...
  insertReminder(String appid, text, String text2, String text3,
      String prioritas, String alarm) {}
}
